...
public class MyRecyclerNewViewAdapter extends RecyclerView.Adapter<MyRecyclerNewViewAdapter.DataObjectHolder> {
    private static String LOG_TAG = "MyRecyclerNewViewAdapter";
    ...
    public MyRecyclerNewViewAdapter(Context myContext, ArrayList<MyJobsRowItem> myDataset) {
        mContext = myContext;
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(final DataObjectHolder holder, final int position) {
        ...
        int textSize = mContext.getResources().getDimensionPixelSize(R.dimen.text_size_18);
        ...
        holder.content.post(new Runnable() {
            ...
            public void run() {
                ...
                if((content != null) && (!content.equals("")) && (!content.equals("null")) && (content.length() > 0) && (lineCount > 2)) {
                    if (MyNewJobsTabFragment.flag[position] == 0) {
